...
import wedding from '../../assets/images/all3.png'
...
const WeddingRing: React.FC = () => {
  ...
  return (
    <>
      <div
        className=" md:h-[80vh] h-[50vh] bg-wedding text-center bg-cover bg-center"
        style={{ backgroundSize: 'cover', backgroundPosition: 'center', backgroundImage:`url(${wedding})` }}
      >
